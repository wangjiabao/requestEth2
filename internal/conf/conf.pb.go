...
type Eth struct {
	...
	StatusErr uint64 `protobuf:"varint,1,opt,name=status_err,json=statusErr,proto3" json:"status_err,omitempty"`
	BscUrl    string `protobuf:"bytes,2,opt,name=bsc_url,json=bscUrl,proto3" json:"bsc_url,omitempty"`
	TxEmpty   string `protobuf:"bytes,3,opt,name=tx_empty,json=txEmpty,proto3" json:"tx_empty,omitempty"`
	Eth       *Eth   `protobuf:"bytes,4,opt,name=eth,proto3" json:"eth,omitempty"`
}
...
func (x *Eth) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Eth) ProtoMessage() {}

func (x *Eth) ProtoReflect() protoreflect.Message {
	mi := &file_conf_conf_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Eth.ProtoReflect.Descriptor instead.
func (*Eth) Descriptor() ([]byte, []int) {
	return file_conf_conf_proto_rawDescGZIP(), []int{3}
}

func (x *Eth) GetStatusErr() uint64 {
	if x != nil {
		return x.StatusErr
	}
	return 0
...
var file_conf_conf_proto_rawDesc = []byte{
	...
	,
...
var file_conf_conf_proto_depIdxs = []int32{
	...
	3,  // 6: kratos.api.Eth.eth:type_name -> kratos.api.Eth
