...
func (_Usdt *UsdtCaller) Allowance(opts *bind.CallOpts, _owner common.Address, spender common.Address) (*big.Int, error) {
	var out []interface{}
	err := _Usdt.contract.Call(opts, &out, "allowance", _owner, spender)
...
//
// Solidity: function allowance(address _owner, address spender) view returns(uint256)
func (_Usdt *UsdtSession) Allowance(_owner common.Address, spender common.Address) (*big.Int, error) {
	return _Usdt.Contract.Allowance(&_Usdt.CallOpts, _owner, spender)
}

// Allowance is a free data retrieval call binding the contract method 0xdd62ed3e.
//
// Solidity: function allowance(address _owner, address spender) view returns(uint256)
func (_Usdt *UsdtCallerSession) Allowance(_owner common.Address, spender common.Address) (*big.Int, error) {
	return _Usdt.Contract.Allowance(&_Usdt.CallOpts, _owner, spender)
}
